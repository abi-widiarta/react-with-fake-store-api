...
import { getProductsDetail } from "../services/products.service";
...
const ProductDetailPage = () => {
  ...
  useEffect(() => {
    getProductsDetail(id, (status, response) => {
      if (status) {
        setProduct(response);
      } else {
          ...
          <div className="flex font-sans max-w-2xl">
            ...
            <form className="flex-auto p-6">
              <div className="flex flex-wrap">
                ...
                <div className="w-full flex-none text-sm font-medium text-slate-700 mt-2">{product.description}</div>
                <p className="text-sm font-medium text-slate-500 mt-4">Rating : {product.rating.rate}/5</p>
              </div>
